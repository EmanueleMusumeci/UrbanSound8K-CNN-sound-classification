...
if __name__=="__main__":
    ...
    #audio_meta, audio_raw_mm, spectro_mm = compact_urbansound_dataset(DATASET_DIR, folds = [1], spectrogram_bands=128)
    #audio_meta, audio_raw_mm, spectro_mm = compact_urbansound_dataset(DATASET_DIR, folds = [2], spectrogram_bands=128)
    #audio_meta, audio_raw_mm, spectro_mm = compact_urbansound_dataset(DATASET_DIR, folds = [3], spectrogram_bands=128)
    #audio_meta, audio_raw_mm, spectro_mm = compact_urbansound_dataset(DATASET_DIR, folds = [4], spectrogram_bands=128)
    #audio_meta, audio_raw_mm, spectro_mm = compact_urbansound_dataset(DATASET_DIR, folds = [5], spectrogram_bands=128)
    #audio_meta, audio_raw_mm, spectro_mm = compact_urbansound_dataset(DATASET_DIR, folds = [6], spectrogram_bands=128)
    #audio_meta, audio_raw_mm, spectro_mm = compact_urbansound_dataset(DATASET_DIR, folds = [7], spectrogram_bands=128)
    #audio_meta, audio_raw_mm, spectro_mm = compact_urbansound_dataset(DATASET_DIR, folds = [8], spectrogram_bands=128)
    #audio_meta, audio_raw_mm, spectro_mm = compact_urbansound_dataset(DATASET_DIR, folds = [9], spectrogram_bands=128)
    ...
    with code_timer("load_compacted_dataset", debug=True):
        audio_meta, audio_raw, audio_spectrograms = load_compacted_dataset(DATASET_DIR,folds = [1], spectrogram_bands=128)
