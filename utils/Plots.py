...
def plot_scores(model_name, model_dir, tasks={"argument_identification":"Argument identification","argument_classification":"Argument classification"},
...
def comparative_plots(model_names, model_dir, 
                                            tasks={"argument_identification":"Argument identification","argument_classification":"Argument classification"},
                                            metrics={"F1-macro":["f1"]}, 
                                            from_epoch=0, to_epoch=0, epochs_skip=0, save_to_file=False,
